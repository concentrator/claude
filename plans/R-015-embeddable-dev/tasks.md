...
- [x] T-038 (R-015) [fix]: Embed committability - the vendored
  ...
  `.gitignore` allowlist entries for the vendored paths, or write them);
  add a test that no vendored path is git-ignored. Re-verify AC1 against a
  real clone. (AC1) `depends-on: T-031`
