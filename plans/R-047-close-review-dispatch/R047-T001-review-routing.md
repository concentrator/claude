...
- [ ] `branch-plan.md § Closing routine` step 1: the content-keyed
...
- [ ] `documentation.md § Verification gate`: state what clears the
...
- [ ] `delegation.md § Close-review fan-out` cites the content rule
