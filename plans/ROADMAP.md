...
- [ ] R-047: Close-review dispatch for every task tag - a `doc`, `test`,
      or `mnt` branch has no declared close-review route, the gap R-046
      closed for the execution dispatch. (stub - shape via
      `/dev plan R`)
