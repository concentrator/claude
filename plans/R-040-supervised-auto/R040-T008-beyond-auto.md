...
- [x] `supervise.md § Dispatch`: state what a supervisor does when the
...
- [x] `companions/declarations.md § Supervisor bounds`: the merge
...
- [x] `companions/toolchain.md`: the push carve-out narrows the deny to
