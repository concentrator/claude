...
- [ ] Compact `ROADMAP.md` closed entries to one-line index items: dated
...
- [ ] Fix the `ROADMAP.md` header's stale `rules/planning.md` pointer
...
- [ ] State-the-present pass over the open initiatives'
