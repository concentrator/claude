...
- [x] Fold `### Prune dead prose` into the Cleanup bullet: dead prose
  is Cleanup's, defined by the three gates stated in that bullet;
  Compliance loses the sentence that claimed the gates.
- [x] The Cross-file integrity bullet states the maximal reading: any
...
- [x] `skills/dev/layout.md` line 17: `MAINTENANCE.md` is written by
