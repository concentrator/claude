...
- [x] Indexes: `git mv .claude/ROADMAP.md .claude/plans/ROADMAP.md`,
...
- [x] Requirements: `git mv .claude/plans/REQ-001.md
      ...
      (T-015..T-017).
- [x] Batches: create `.claude/plans/R-001-route-sweep/batches/`;
...
- [x] Complete the branch: grep wallarm-api-js docs (`CLAUDE.md`,
