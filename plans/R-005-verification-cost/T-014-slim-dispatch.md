...
- [ ] implementer-prompt.md: replace CLAUDE.md-duplicating convention
...
- [ ] implementer-prompt.md: trim Code Organization to its
      ...
      CLAUDE.md home).
- [ ] spec-reviewer-prompt.md: add convention-drift flagging to the
...
- [ ] delegating-to-agents SKILL.md per-commit dispatch bullet:
      ...
      the edit.
- [ ] Record the trade where the checkpoint compares it: extend the
