...
- [x] `branch-plan.md`: a section owning the session boundary - the
...
- [x] `branch-plan.md`: the doc-load discipline - one doc-load phase
...
- [x] Pointers: `auto.md § Checkpoint`, `finish.md § 4` and
