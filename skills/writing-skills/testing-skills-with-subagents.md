...
## Skill Type → Test Design

Different skill types need different test approaches. Pick the right one
before writing baseline scenarios.
...
After writing ANY skill, complete the full deployment process before
starting another:
...
The Testing Checklist below is mandatory for EACH skill. Deploying
