...
Bring the current project's `dev/docs/` feature docs onto the doc-first
...
1. **Pre-flight.** `dev/docs/` is the docs home (`layout.md § Docs`); the
...
3. **Deliver.** The new or updated docs, the `dev/docs/index.md` entries,
