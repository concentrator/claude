...
description: Use when facing 2+ independent tasks without shared state.
tags: reference
---
...
| Task | subagent_type |
|---|---|
| Read-only research, exploration, "where is X", "what does Y do" | `Explore` (no Edit/Write/Bash) |
| Editing files, running build/test/format, applying fixes, multi-step implementation | `general-purpose` |
