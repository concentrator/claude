...
- **Operative instructions only.** State the WHAT, not the why - rationale belongs in requirements/DESIGN, not the rule. (Phrasing and terminology: `CLAUDE.md § Writing`.)
