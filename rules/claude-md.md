...
- **Operative instructions only.** State the WHAT, not the why - rationale belongs in requirements/DESIGN. Compaction cuts framing to the operative WHAT, never meaning. (Phrasing: `CLAUDE.md § Writing`.)
