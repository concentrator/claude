...
- [x] T-073 (R-033) [refactor]: rework the feature-docs layer as the Reference application - `layout.md § Docs` (skeleton + folded detail bar), `companions/docs-adoption.md`, `docs.md`; reconcile R-032 (depends-on T-071, T-072)
