...
- [x] R069-T001 [doc]: the supervised-run lessons land as rules -
  ...
  the channel-traps list, the gating pre-flight line, and the
  operator half of prompt ownership - each rule stated once, the
  other file citing it, every rule traced to a
  `R040-T026-two-project-run.findings.md` failure
