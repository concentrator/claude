...
- Item 7: the gate's header comment is rewritten at 5 lines, under the
  6 it had on the default branch, so it still describes the gate rather
  than the stale pre-branch scope.

## Review
- [x] An existing or renamed findings file is scanned as a branch plan
