...
spells its fixture in Cyrillic, three times on two adjacent lines.
`install-dev.sh --project` ships the file as a tracked copy, and a git
host that rejects Cyrillic in file content then rejects every adopter
push touching it.
