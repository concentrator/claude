- [ ] Two companion files still let the runner answer a seat's question
  ...
  `companions/declarations.md § Supervisor bounds`, whose grant bullet
  covers "implementation-level resolutions of worker questions" - also
  the "worker" wording `run.md` retired. The runbook carries three more
  sites: `§ The loop`'s diagram routes "asking? -> implementation:
  answer" and gives the runner box "resolves, dispatches, answers,
